  ...
  return (
    <>
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-col-3 mb-8 md:gap-8">
          ...
          <div className="col-span-2">
            <div className="mb-6">
              <h1 className="text-3xl card-title">
                ...
                {hireable && <div className="mx-1 badge bade-info">Hireable</div>}
              </h1>
              <p>{bio}</p>
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
          ...
          <div className="stats">
            <div className="stat-figure text-secondary">
              <FaUserFriends className="text-2xl md:text-4xl" />
            </div>
          ...
          <div className="stats">
            <div className="stat-figure text-secondary">
              <FaCodepen className="text-2xl md:text-4xl" />
            </div>
